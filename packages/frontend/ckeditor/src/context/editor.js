...
class CustomCommentsAdapter extends ContextPlugin {
  ...
  getInitialComments() {
    ...
    for (const commentThread of commentThreadsData) {
      repository.addCommentThread(commentThread);
...
Context.builtinPlugins = [CustomCommentsAdapter, WideSidebar, NonEditorFieldsIntegration];
...
export { ClassicEditorBase, Context };
